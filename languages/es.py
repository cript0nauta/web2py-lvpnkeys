...
'Descargar todas las claves': 'Descargar todas las claves',
...
'shell': 'shell',
'Si tenés tu nodo, lo podés registrar': 'Si tenés tu nodo, lo podés registrar',
'site': 'sitio',
